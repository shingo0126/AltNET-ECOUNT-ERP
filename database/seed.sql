...
-- 재실행 안전: 이미 데이터가 있으면 업데이트, 없으면 신규 삽입
-- ============================================
...
-- 샘플 매출 업체
INSERT IGNORE INTO companies (name, contact_person, phone, email, zipcode, address, address_detail) VALUES
...
-- 샘플 매입 업체  
INSERT IGNORE INTO vendors (name, contact_person, phone, email, zipcode, address, address_detail) VALUES
...
-- 샘플 판매 제품 코드
INSERT IGNORE INTO sale_items (sort_order, name) VALUES
(1, '하드웨어 판매'),
(2, '소프트웨어 라이선스'),
(3, '기술 서비스'),
(4, '유지보수 계약'),
